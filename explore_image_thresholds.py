...
# This function applies different gradient and color thresholding
# techniques (Sobel edge, HLS/LAB color thresholding etc.)
# and displays the output images to help determine which 
# thresholding algorithm to use for the advanced lane finding project.
